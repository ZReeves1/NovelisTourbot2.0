...
# address - device that l2-unreliable-server is running on
# timeout - wait timeout * 0.625ms before dropping unACK'd packets
# num_packets - number of 627-byte packets to send on connect
bt_addr = "64:BC:0C:FA:26:4F"
timeout = 2
num_packets = 10
